ALTER FUNCTION [dbo].[fn_STOCK_Movtos_Envio_Ordenes_Confeccion_DESTINO]
(
    @IdArticulo int,
	@DesdeFecha date,
	@HastaFecha date,
...
from 
(
		select cab.idrow as IdRow_Cabecera, lin.id as IdLinea, cab.almacen as almacen,lin.ARTICULO_CRUDO as articulo,
