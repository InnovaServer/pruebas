...
GO
ALTER FUNCTION [dbo].[fn_STOCK_Transformaciones_Origen]
(
    @IdArticulo int,
	@HastaFecha date
)
...
(
	...
	(
		select *
		from fn_STOCK_Movtos_Transformaciones_Origen(@IdArticulo,'01/01/1900',@HastaFecha,1) -- Como se piden movimientos para stock, la FechaDesde no sirve para nada
	) temp1
