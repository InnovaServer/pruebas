ALTER FUNCTION [dbo].[fn_STOCK_Movtos_Produccion_Entradas]
(
    @IdArticulo int,
	@DesdeFecha date,
	@HastaFecha date,
...
from 
(
		select cab.idrow as IdRow_Cabecera, lin.id as IdLinea, cab.almacen as almacen,disp.ARTICULO as articulo,
