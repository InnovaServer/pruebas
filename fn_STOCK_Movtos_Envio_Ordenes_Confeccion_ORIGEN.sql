ALTER FUNCTION [dbo].[fn_STOCK_Movtos_Envio_Ordenes_Confeccion_ORIGEN]
(
    @IdArticulo int,
	@DesdeFecha date,
	@HastaFecha date,
...
from 
(
		select cab.idrow as IdRow_Cabecera, lin.id as IdLinea, cab.almacen as almacen,lin.articulo as articulo,
		...
		and cab.ENVIADA = 1
		and cab.tipo = 1 -- Solo confeccion
