...
GO
CREATE FUNCTION [dbo].[fn_STOCK_Produccion_Entradas]
(
    @IdArticulo int,
	@HastaFecha date
)
...
(
	...
	(
		select *
		from fn_STOCK_Movtos_Produccion_Entradas(@IdArticulo,'01/01/1900',@HastaFecha,1) -- Como se piden movimientos para stock, la FechaDesde no sirve para nada
	) temp1
